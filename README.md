...
Go to [Maven Central](https://search.maven.org/artifact/edu.uiowa.cs.clc/kind2-java-api/0.3.2/jar) and copy the appropriate code snippet for your build management tool.

...
```groovy
implementation 'edu.uiowa.cs.clc:kind2-java-api:0.10.1'
```

#### Other build management tools
Go to [Maven Central](https://search.maven.org/artifact/edu.uiowa.cs.clc/kind2-java-api/0.10.1/jar) and copy the appropriate code snippet for your build management tool.

...
import edu.uiowa.kind2.excel.ExcelFormatter;
import edu.uiowa.kind2.results.Property;
import edu.uiowa.kind2.results.layout.Layout;
import edu.uiowa.kind2.results.layout.SingletonLayout;
...
public class Result extends AnalysisResult implements PropertyChangeListener {
   ...
   *
   * @param name       Name of the results
   * @param properties Property names to track
   */
   ...
   *
   * @param name     Name of the results
   * @param renaming Renaming to apply to properties
   */
   ...
   *
   * @param name       Name of the results
   * @param properties Property names to track (pre-renaming)
   * @param renaming   Renaming to apply to properties
   */
   ...
   * @param name         Name of the results
   * @param properties   Property names to track (pre-renaming)
   * @param invertStatus True if the status of the property of the same index in properties should
   *                     be inverted
   */
   ...
   *
   * @param property     Property to be tracked (pre-renaming)
   * @param invertStatus True if finding a model means success. Otherwise false.
   * @return The PropertyResult object which will store the results of the property
   */
   ...
   *
   * @param properties Properties to be tracked (pre-renaming)
   * @return List of the PropertyResult objects which will store the results of the properties
   */
   ...
   *
   * @param name Name of property to retrieve (pre-renaming)
   ...
   *
   * @param file   File to write Excel spreadsheet to
   * @param layout Layout information for counterexamples, defined over renamed signals
   * @see Layout

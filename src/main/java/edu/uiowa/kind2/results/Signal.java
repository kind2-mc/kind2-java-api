 ...
 *
 * @param <T> Type of value contained in the signal
 */
public final class Signal<T extends Value> implements Comparable<Signal<T>> {
   ...
   *
   * @param step Step to query the value at
   * @return Value at the specified step or <code>null</code> if the signal does not have a value on
   *         that step
   */

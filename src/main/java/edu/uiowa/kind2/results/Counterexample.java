...
import edu.uiowa.kind2.excel.ExcelCounterexampleFormatter;
...
import edu.uiowa.kind2.util.CounterexampleFormatter;
...
public final class Counterexample {
   ...
   *
   * @param name Name of the signal to retrieve
   * @return Signal with the specified name, or <code>null</code> if it cannot be found
   */
   ...
   *
   * @param name Name of the signal to retrieve
   * @return Integer signal with the specified name, or <code>null</code> if it cannot be found
   */
   ...
   *
   * @param name Name of the signal to retrieve
   * @return Boolean signal with the specified name, or <code>null</code> if it cannot be found
   */
   ...
   *
   * @param name Name of the signal to retrieve
   * @return Enumerated value signal with the specified name, or <code>null</code> if it cannot be
   *         found
   */
   ...
   *
   * @param name Name of the signal to retrieve
   * @return Real signal with the specified name, or <code>null</code> if it cannot be found
   */
   ...
   * @param layout Layout information for signals in counterexample
   * @see Layout

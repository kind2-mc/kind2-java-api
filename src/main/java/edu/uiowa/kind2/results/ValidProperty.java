...
public final class ValidProperty extends Property {
  ...
  public ValidProperty(String name, String source, int k, double runtime, List<String> invariants,
      Collection<String> ivc, Set<List<String>> invariantSets, Set<List<String>> ivcSets,
  ...
  /**
   * Invariants used to prove property, only available if Kind2Api.setIvcReduction()
   */

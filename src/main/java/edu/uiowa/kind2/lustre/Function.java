...
/**
 * This class represents a function. Kind 2 supports the {@code function} keyword which is used just
 * like the {@code node} one but has slightly different semantics. Like the name suggests, the
...
public class Function extends Ast {
  ...
  public Function(String id, List<VarDecl> inputs, ContractBody contractBody, List<VarDecl> outputs,
      List<VarDecl> locals, List<Equation> equations, List<Expr> assertions,

 ...
 * using the method {@link Result#analyzeJsonResult(String)}.
 * The returned instance contains a list of {@link NodeResult} which are the results of the sub-components.
 * It also contains a list of {@link Log} for the logs generated by kind2.
 * By default the returned instance uses the names in the lustre code, and surround them with {{}}.
 * These opening and closing symbols can be changed using the method {@link Result#setOpeningSymbols(String)}
 * and {@link Result#setClosingSymbols(String)} respectively.
 */
public class Result
{
  /**
  ...
  /**
   * @return a list of {@link Property} for all falsified properties including the falsified properties
  ...
  /**
   * @return a list of {@link Property} for all valid properties including the valid properties
   * for the subcomponents.
   */
